...
export const SELECTED_VIDEO_SUCCESS = 'SELECTED_VIDEOS_SUCCESS'
export const SELECTED_VIDEO_FAIL = 'SELECTED_VIDEOS_FAIL'
export const SELECTED_VIDEO_REQUEST = 'SELECTED_VIDEOS_REQUEST'

export const RELATED_VIDEO_SUCCESS = 'RELATED_VIDEOS_SUCCESS'
export const RELATED_VIDEO_FAIL = 'RELATED_VIDEOS_FAIL'
export const RELATED_VIDEO_REQUEST = 'RELATED_VIDEOS_REQUEST'
